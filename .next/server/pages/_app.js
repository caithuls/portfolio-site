...
const StyledTransitionGroup = external_styled_components_default()(external_react_transition_group_namespaceObject.TransitionGroup)`
  position: relative;
`;
...
function App({ Component , pageProps , router: router1  }) {
