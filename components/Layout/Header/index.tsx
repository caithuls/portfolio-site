...
import { COLOR_BLACK, COLOR_WHITE, COLOR_DARK_PURPLE } from "lib/colorPalette";
    ...
    <StickyNav darkTheme={darkTheme}>
      <Wrapper>
        <div>
          ...
          {/*  <Navigation href="/art" text="Art" /> 
          <Navigation href="/contact" text="Contact" /> */}
        </div>
        <button onClick={changeTheme} aria-label="change-theme">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
            fill={darkTheme ? COLOR_DARK_PURPLE : COLOR_WHITE}
            stroke={darkTheme ? COLOR_DARK_PURPLE : COLOR_WHITE}
          >
            {darkTheme ? (
              <path
                strokeLinecap="round"
